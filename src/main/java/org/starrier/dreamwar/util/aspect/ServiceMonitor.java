...
import org.starrier.dreamwar.util.common.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     */
    @AfterThrowing(pointcut = "org.starrier.dreamwar.util.aspect.ServiceMonitor.serviceLayer()monitor.ServiceMonitor.serviceLayer()", throwing = "e")
