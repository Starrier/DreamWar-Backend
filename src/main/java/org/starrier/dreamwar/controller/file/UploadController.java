...
import org.starrier.dreamwar.repository.repository.FilePathRepository;
...
public class UploadController {
    ...
    public List<String> uploadImages(final @RequestParam("file") MultipartFile[] files) {
        ...
        String savePath = String.format("/%s/img/%s/%s", projectName, org.starrier.dreamwar.util.RandomUtils.randomNum(2), org.starrier.dreamwar.util.RandomUtils.randomNum(2));
    ...
    private static String getRandomUniqName() {
        String prefix = org.starrier.dreamwar.util.RandomUtils.randomNum(1);
    ...
    private boolean saveFile(final String savePath, final String name, final MultipartFile file) {
        ...
        try {
            ...
            log.error("save file due to error", e);
            return false;
        }
        return true;
    }
