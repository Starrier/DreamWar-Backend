package org.starrier.dreamwar.monitor;
...
public class ServiceMonitor {
     ...
     */
    @AfterThrowing(pointcut = "org.starrier.dreamwar.monitor.ServiceMonitor.serviceLayer()monitor.ServiceMonitor.serviceLayer()", throwing = "e")
